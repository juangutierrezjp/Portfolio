...
const SvgPostgre = (props) => (
  ...
  >
    <style>
      {
        ".postgre_svg__B{stroke-linecap:round}.postgre_svg__C{stroke-linejoin:round}.postgre_svg__D{stroke-linejoin:miter}.postgre_svg__E{stroke-width:.716}"
      }
    </style>
    <g fill="none" stroke="#fff">
      ...
      />
      <g className="postgre_svg__E">
        <g className="postgre_svg__B">
          <path
        ...
        <g className="postgre_svg__C">
          ...
          <path
            ...
            className="postgre_svg__B"
          />
        </g>
      </g>
      <g fill="#fff" className="postgre_svg__D">
        <path
          strokeWidth={0.239}
      ...
      <path
        ...
        className="postgre_svg__B postgre_svg__C postgre_svg__E"
      />
    </g>
  </svg>
);
export default SvgPostgre;